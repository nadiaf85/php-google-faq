...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light d-flex flex-column">
            <div class="container-fluid">
                <a class="navbar-brand d-flex align-items-center" href="#">
                    <img src="logo_Google.jpeg" alt="" width="70" height="40" class="d-inline-block align-text-top">
            ...
            <div class="container-fluid border-bottom border-secondary">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-primary font-weight-bold border-bottom border-primary border-3">Domande frequenti</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <main>
        <div class="container">
            <div class="row">
                <?php
                foreach ($faq as $key => $elemento){
                    foreach ($elemento as $domanda){
                    echo $domanda; 
                    }
                };
                ?>
